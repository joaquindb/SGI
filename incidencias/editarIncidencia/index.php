...
?>
    <div class='panel panel-default grid'>
      ...
      <div class='panel-heading'>
          ...
          <?php echo _LBL_CAB_EDIT_INCIDENCE?>
      ...
      <div class='panel-form' >
            ...
            <div class="col-lg-12">
              <div class="col-lg-3"></div>
                ...
                <div class="form-group col-lg-3">
                  <label class="control-label"><?php echo _LBL_ESTADO_INC?></label>
            ...
            <div class="col-lg-12">
              ...
              <div class='form-actions actions col-lg-2'>
                  ...
                  <button class='btn btn-primary' onclick="jaxon_guardar_incidencia($('#select_ordenador_incidencia').val(),$('#select_prioridad_incidencia').val(),$('#resumen_incidencia').val(),$('#select_estado_incidencia').val(),$('#descripcion_incidencia').val())"><?php echo _LBL_GUARDAR?></button>
              </div>
            </div>
